...
class UIHelper: NSObject {
    ...
    static func showAlert(_ target : UIViewController? = nil, title:String?, message:String?, buttons:[String], style:UIAlertController.Style, alertHandler: ((_ alert:UIAlertController, _ desicion:Int) -> Void)?) {
        ...
        {
            let cancelButton = UIAlertAction(title: "İptal", style: UIAlertAction.Style.cancel, handler: { (UIAlertAction) -> Void in
